    ...
    <div>
      <div className="mb-3 flex items-center justify-between">
        <input
          ...
          className="w-64 rounded border border-gray-300 px-3 py-1.5 text-sm shadow-sm focus:border-brand-navy focus:outline-none focus:ring-1 focus:ring-brand-navy"
        />
            ...
            {table.getHeaderGroups().map((hg) => (
              <tr key={hg.id}>
                {hg.headers.map((h) => {
                  ...
                  const headerBg = isAging ? "bg-brand-orange" : "bg-brand-navy";
